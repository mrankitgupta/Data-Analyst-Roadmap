...
|Day 28| Continued with **Python** (Pycharm - Featues, Important tools, Useful Plugins) | [YouTube 1](https://www.youtube.com/watch?v=WGJJIrtnfpk)| 
|Day 29| Continued with **Python** (Modules, Comments, Pip, Docstrings) | [Youtube 2](https://www.youtube.com/watch?v=EyEqWFvLDT8)| 
|Day 30| Continued with **Python** (Indentation, Packages in Python, Modules vs Packages) | [Python Lessons for Practice](https://github.com/mrankitgupta/PythonLessons)| 
